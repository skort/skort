...
local admin_num = "📋 تعداد ادمین در گروه : "..result.admins_count.."\n"
local user_num = "📋 تعداد کاربر فعال در گروه : "..result.participants_count.."\n"
local kicked_num = "📋 تعداد کاربران اخراج شده از گروه  : "..result.kicked_count.."\n"
